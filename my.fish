...
if type -q xcode-select
    ...
    abbr addbin "fish_add_path $opt/coreutils/bin $opt/coreutils/libexec/gnubin $opt/findutils/libexec/gnubin $opt/util-linux/bin"
...
function fish_greeting
    ...
    if type -q fastfetch
        fastfetch -l ~/.ans -c $my/fastfetch.json --separator \r\t\t\t\t\t\t\t\t\t\t\t\t\t\b\b\b\b\b\b
    end
